...
def setGenAliases(t, signal='4Mu'):
    ...
    for i, particle in enumerate(plist):
        for attribute in ('pdgID', 'pt', 'eta', 'phi', 'mass', 'energy', 'charge', 'x', 'y', 'z', 'd0', 'cosAlpha', 'Lxy', 'pairDeltaR'):
            if attribute in ('d0', 'cosAlpha', 'Lxy', 'pairDeltaR') and particle[0:2] != 'mu' and particle[0] != 'j': continue
