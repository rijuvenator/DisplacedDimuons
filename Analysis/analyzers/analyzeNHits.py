...
def declareResolutionHists(self,name, maxHits=4):
    ...
    if maxHits > 4:
        ...
        self.HistInit('%s_5+hit_gauss'%name, '%s_4+hit_gauss; (DSA(q/p_{T}) - Gen(q/p_{T}))/Gen(q/p_{T}); Count'%name, 50, -5, 5)
            ...
            if ndt == 0:
                ...
                if gen.pt != 0: 
                    ...
                    if nstat > 4:
                        ...
                        self.HISTS['csc&dt_5+hit_gauss'].Fill((1.*reco.charge/reco.pt - 1.*gen.charge/gen.pt)/(1.*gen.charge/gen.pt))
                    else:
