...
cd DisplacedDimuons/Analysis/dumpers
python cutEfficiencies.py --signalpoints {mH} {mX} {cTau}
rm -f core.*
'''
...
if not args.LOCAL:
	...
	parallel_command = ['bash', '-c',  'parallel --colsep " " python cutEfficiencies.py --signalpoints :::: <(echo -e "{ARGLIST}")'.format(
