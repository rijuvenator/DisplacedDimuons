...
void SplitData(Long64_t globaljob=0)
{
  ...
  if (era == "B")
  {
    f = TFile::Open("~/eos/DisplacedDimuons/NTuples/ntuple_DoubleMuonRun2016B-07Aug17-v2.root");
  }
  else
  {
    f = TFile::Open("~/eos/DisplacedDimuons/NTuples/ntuple_DoubleMuonRun2016"+era+"-07Aug17.root");
  }
