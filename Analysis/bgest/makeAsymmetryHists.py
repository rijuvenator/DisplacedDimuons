...
for sample in itertools.chain(HG.BGORDER, ['Data']):
    ...
    hists[sample] = {
        ...
        'LxySig-SplitDPhi-Big' : {
            'Less' : {'plot': R.TH1F('hLessLxySigBig'  +'_'+sample, ';L_{xy}/#sigma_{L_{xy}};Counts'                     ,  86, 7., 50.            ), 'legName':'|#Delta#Phi| < #pi/2'},
            'More' : {'plot': R.TH1F('hMoreLxySigBig'  +'_'+sample, ';L_{xy}/#sigma_{L_{xy}};Counts'                     ,  86, 7., 50.            ), 'legName':'|#Delta#Phi| > #pi/2'},
        },
        'LxySig-SplitDPhi-Edges' : {
            'Less' : {'plot': R.TH1F('hLessLxySigEdges'+'_'+sample, ';L_{xy}/#sigma_{L_{xy}};Counts'                     ,  86, 7., 50.            ), 'legName':'|#Delta#Phi| < #pi/2'},
            'More' : {'plot': R.TH1F('hMoreLxySigEdges'+'_'+sample, ';L_{xy}/#sigma_{L_{xy}};Counts'                     ,  86, 7., 50.            ), 'legName':'|#Delta#Phi| > #pi/2'},
        },
        ...
        'deltaPhi-SplitLxySig-Big' : {
            'Less' : {'plot': R.TH1F('hLessDeltaPhiBig'+'_'+sample, ';|#Delta#Phi| for L_{xy}/#sigma_{L_{xy}} > 7;Counts', 100, 0., R.TMath.Pi()/2.), 'legName':'|#Delta#Phi| < #pi/2'},
            'More' : {'plot': R.TH1F('hMoreDeltaPhiBig'+'_'+sample, ';|#Delta#Phi| for L_{xy}/#sigma_{L_{xy}} > 7;Counts', 100, 0., R.TMath.Pi()/2.), 'legName':'|#Delta#Phi| > #pi/2'},
        },
    }

    singles[sample] = {
        'deltaPhi-Big' : {'plot': R.TH1F('hDeltaPhiBig'+'_'+sample, ';|#Delta#Phi| for L_{xy}/#sigma_{L_{xy}} > 7;Counts', 100, 0., R.TMath.Pi()   ), 'legName':''},
...
X = R.TFile.Open('roots/Hists.root' if int(ARGS.LXYSIGCUTOFF) == 7 else 'roots/Hists_{}.root'.format(int(ARGS.LXYSIGCUTOFF)), 'RECREATE')
for sample in hists:
