...
if CUTSTRING == '':
    CUTSTRING = 'NS_NH_FPTE_HLT_REP_PT_TRK_NDT_DCA_PC_LXYE_MASS_CHI2_VTX_COSA_NPP_LXYSIG_OS_DPHI'
    print 'Defaulting to', CUTSTRING

lumiExtra = {
    'NS_NH_FPTE_HLT_REP_PT_TRK_NDT_DCA_PC_LXYE_MASS_CHI2_VTX_COSA_NPP_LXYSIG_OS_DPHI'  : ' |#Delta#Phi| < #pi/2',
    'NS_NH_FPTE_HLT_REP_PT_TRK_NDT_DCA_PC_LXYE_MASS_CHI2_VTX_COSA_NPP_LXYSIG_OS_IDPHI' : ' |#Delta#Phi| > #pi/2',
}
