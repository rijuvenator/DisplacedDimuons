...
Combined_NS_NH_FPTE_HLT_REP_PQ1_PT_PC_LXYE_MASS_CHI2
...
for i in Combined_NS_NH_FPTE_HLT_REP_PQ1_PT_PC_LXYE_MASS_CHI2
do
...
for i in Trig_Combined_NS_NH_FPTE_HLT_REP_PQ1_PT_PC_LXYE_MASS_CHI2_HTo2XTo2Mu2J
do
...
do
    ...
    do
        for pt in 2Mu2J MC
        do pdfunite NS_NH_FPTE_HLT_REP_PQ1_PT_PC_LXYE_MASS_CHI2/ZEP_${qt}_${rt}_*_${pt}.pdf Combo_${qt}_${rt}_${pt}.pdf
        done
    done
done
...
parallel python makeZephyrPlots.py --cutstring ::: NS_NH_FPTE_HLT_REP_PQ1_PT_PC_LXYE_MASS_CHI2

for cs in NS_NH_FPTE_HLT_REP_PQ1_PT_PC_LXYE_MASS_CHI2;
do
    mkdir -p pdfs/${cs}/
...
do
    ...
    do
        z=''
        for i in NS_NH_FPTE_HLT_REP_PQ1_PT_PC_LXYE_MASS_CHI2
        do
