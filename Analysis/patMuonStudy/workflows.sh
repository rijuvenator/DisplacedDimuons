...
_Combined_NS_NH_FPTE_HLT_REP_PT_DCA_PC_LXYE_MASS_CHI2_VTX_COSA_NPP_LXYSIG_TRK_OS_NDT_{DPHI,IDPHI}
...
rehaddAll.py --mode split --tags ZephyrPlots_Combined_NS_NH_FPTE_HLT_REP_PT_DCA_PC_LXYE_MASS_CHI2_VTX_COSA_NPP_LXYSIG_TRK_OS_NDT_{DPHI,IDPHI} --dirs tmp mcbg --samples bigMC data --noPlots --noMove
...
for i in _Combined_NS_NH_FPTE_HLT_REP_PT_DCA_PC_LXYE_MASS_CHI2_VTX_COSA_NPP_LXYSIG_TRK_OS_NDT_{DPHI,IDPHI}
do
...
for i in _Trig_Combined_NS_NH_FPTE_HLT_REP_PT_DCA_PC_LXYE_MASS_CHI2_VTX_COSA_NPP_LXYSIG_TRK_OS_NDT_{DPHI,IDPHI}_HTo2XTo2Mu2J
do
...
do
    ...
    do
        for pt in 2Mu2J MC
        do pdfunite NS_NH_FPTE_HLT_REP_PT_DCA_PC_LXYE_MASS_CHI2_VTX_COSA_NPP_LXYSIG_TRK_OS_NDT_{DPHI,IDPHI}/ZEP_${qt}_${rt}_*_${pt}.pdf Combo_${qt}_${rt}_${pt}.pdf
        done
    done
done
...
parallel python makeZephyrPlots.py --cutstring ::: NS_NH_FPTE_HLT_REP_PT_DCA_PC_LXYE_MASS_CHI2_VTX_COSA_NPP_LXYSIG_TRK_OS_NDT_{DPHI,IDPHI}

for cs in NS_NH_FPTE_HLT_REP_PT_DCA_PC_LXYE_MASS_CHI2_VTX_COSA_NPP_LXYSIG_TRK_OS_NDT_{DPHI,IDPHI};
do
    mkdir -p pdfs/${cs}/
...
do
    ...
    do
        z=''
        for i in NS_NH_FPTE_HLT_REP_PT_DCA_PC_LXYE_MASS_CHI2_VTX_COSA_NPP_LXYSIG_TRK_OS_NDT_{DPHI,IDPHI}
        do
