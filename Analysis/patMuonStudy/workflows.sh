...
_Combined_NS_NH_FPTE_HLT_REP_PT_PC_LXYE_MASS_CHI2_VTX_COSA_NPP_DCA_LXYSIG
...
rehaddAll.py --mode split --tags ZephyrPlots_Combined_NS_NH_FPTE_HLT_REP_PT_PC_LXYE_MASS_CHI2_VTX_COSA_NPP_DCA_LXYSIG --dirs tmp mcbg --samples bigMC data --noPlots --noMove
...
for i in _Combined_NS_NH_FPTE_HLT_REP_PT_PC_LXYE_MASS_CHI2_VTX_COSA_NPP_DCA_LXYSIG
do
...
for i in _Trig_Combined_NS_NH_FPTE_HLT_REP_PT_PC_LXYE_MASS_CHI2_VTX_COSA_NPP_DCA_LXYSIG_HTo2XTo2Mu2J
do
...
do
    ...
    do
        for pt in 2Mu2J MC
        do pdfunite NS_NH_FPTE_HLT_REP_PT_PC_LXYE_MASS_CHI2_VTX_COSA_NPP_DCA_LXYSIG/ZEP_${qt}_${rt}_*_${pt}.pdf Combo_${qt}_${rt}_${pt}.pdf
        done
    done
done
...
parallel python makeZephyrPlots.py --cutstring ::: NS_NH_FPTE_HLT_REP_PT_PC_LXYE_MASS_CHI2_VTX_COSA_NPP_DCA_LXYSIG

for cs in NS_NH_FPTE_HLT_REP_PT_PC_LXYE_MASS_CHI2_VTX_COSA_NPP_DCA_LXYSIG;
do
    mkdir -p pdfs/${cs}/
...
do
    ...
    do
        z=''
        for i in NS_NH_FPTE_HLT_REP_PT_PC_LXYE_MASS_CHI2_VTX_COSA_NPP_DCA_LXYSIG
        do
